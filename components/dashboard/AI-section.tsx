...
import { Brain, HeartHandshake, Orbit, Sparkles, MessageSquare, FileText } from "lucide-react";
...
export default function AISection() {
  const aiServices = [ 
    ...
    { name: "PDF Summary Generator", href: "/ai/pdf", icon: FileText },
  ];

  return (
    <section className="w-full py-8 sm:py-12 flex justify-center">
      <motion.div
