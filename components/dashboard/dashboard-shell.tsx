...
import { dashboardNavLinks, type DashboardNavLink } from "@/lib/dashboard-data";
...
export function DashboardShell({
  ...
  const links = useMemo<DashboardNavLink[]>(() => dashboardNavLinks, []);
            ...
            return (
              ...
              >
                <Link
                  ...
                  className={cn(
                    "group flex items-center gap-3 rounded-xl px-3 py-2 text-sm font-medium transition border shadow-sm",
                    isActive
                      ? "bg-yellow-50 border-yellow-200 text-gray-900 shadow-[0_3px_12px_rgba(255,215,100,0.28)]"
                      : "border-white text-gray-500 hover:bg-yellow-50 hover:text-gray-800",
  ...
  return (
    <div className="relative isolate min-h-[100vh] bg-white">
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="lg:w-64 xl:w-72">
            ...
            <motion.div
              ...
              className={cn(
                "fixed left-4 top-24 z-40 rounded-2xl border border-yellow-200 bg-white p-5 shadow-lg transition-all lg:sticky lg:top-24 lg:z-auto",
