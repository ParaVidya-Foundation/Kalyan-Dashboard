...
import type { KundliHistory, ProfileStat, UserProfile } from "@/lib/dashboard-data"
...
export function ProfileDashboard({ user, stats, history }: ProfileDashboardProps) {
  ...
  return (
    <>
      <DashboardShell
        title="Profile"
        description="Softly orchestrate your identity, rituals, and astrological signature."
        actions={
          <Button className="rounded-full bg-gray-900 px-5 text-white" onClick={() => setIsEditing(true)}>
      ...
      >
        <motion.section
          ...
          className="rounded-3xl border border-white/60 bg-white/80 p-6 shadow-lg shadow-indigo-100 backdrop-blur-xl"
        >
        ...
        <div className="grid gap-6 lg:grid-cols-2">
                ...
                {history.map((entry) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <Badge
                        variant="outline"
                        className={entry.status === "ready" ? "border-emerald-200 text-emerald-600" : "border-yellow-200 text-yellow-600"}
                      >
          ...
          <Card className="rounded-3xl border-white/60 bg-white/80 shadow-xl shadow-indigo-50">
            <CardContent className="space-y-6 p-6">
              ...
              {["Email nudges", "Daily rituals", "AI insights"].map((label) => (
        ...
        {isEditing && (
          ...
          >
            <motion.div
              ...
              exit={{ opacity: 0, y: -12 }}
              transition={{ duration: 0.3 }}
              className="absolute left-1/2 top-1/2 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 rounded-3xl border border-white/70 bg-white/95 p-6 shadow-2xl"
            ...
            >
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <Input
                    className="mt-1 rounded-2xl border-gray-200"
