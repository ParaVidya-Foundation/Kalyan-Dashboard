...
export default function CoupleScore({ name1, name2, summary, score }: { name1: string, name2: string, summary: string, score: number }) {
  return (
    <div className="w-full max-w-5xl mx-auto rounded-[32px] bg-white shadow-[0_20px_60px_rgba(0,0,0,0.06)] 
