...
const rows = [
  // --- your full dataset unchanged ---
  {
    ...
    result: "Bad",
    notes:
      "No good connection between these horoscopes • male: SamePlanet Sign, female: SamePlanet Sign",
  },
  {
    name: "Rajju",
  ...
  },
  {
    ...
    result: "Neutral",
    notes:
      "Bad but neutralized by friendly Janma Rasi lord • male: Pitha, female: Pitha",
  },
  {
    name: "Vasya Kuta",
  ...
  },
  {
    ...
    result: "Bad",
    notes:
      "No well-being and no longevity, count 1 • male: Dhanishta-3, female: Dhanishta-3",
  },
  {
    name: "Stree Deergha",
    ...
    result: "Bad",
    notes:
      "Constellation count lower than 9, it is 1 • male: Dhanishta-3, female: Dhanishta-3",
  },
  {
    name: "Rasi Kuta",
    ...
    result: "Neutral",
    notes:
      "Bad but neutralized by friendly Janma Rasi lord • male: Aquarius, female: Aquarius",
  },
  {
    name: "Vedha",
  ...
  },
  {
    ...
    result: "Good",
    notes:
      "Boy higher and girl lower or both same Varna • male: Vaisya Workmen, female: Vaisya Workmen",
  },
  {
    name: "Yoni Kuta",
  ...
  },
  {
    ...
    result: "Bad",
    notes:
      "Charts cannot be matched, female chart has more dosha • male: 0, female: 137.5",
  },
  {
  ...
  },
  {
    ...
    result: "Bad",
    notes:
      "Unfavourable: no trikona alignment between Venus/Mars/Jupiter",
  },
  {
    ...
    result: "Good",
    notes:
      "Strong attachment; Sun and Moon are in harmonious positions",
  },
  {
...
export default function MatchTable() {
  return (
    <motion.div
      ...
      className="w-full max-w-5xl mx-auto p-8 rounded-[32px] bg-[#FFFFFF] 
    ...
    >
      ...
      <div className="mt-8 rounded-3xl border border-gray-100 bg-white divide-y divide-gray-100">
        {rows.map((item, idx) => {
          const c = palette[item.result as keyof typeof palette] || palette.Neutral;
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center">
                <span
                  className={`px-4 py-1.5 text-[11px] font-semibold rounded-full border ${c.bg} ${c.text}`}
                >
                  {item.result}
                </span>
              </div>
