...
export function AppleChart({
  ...
  return (
    <GlowCard glowIntensity="subtle" className="p-6">
      {title && (
        <h3 className="text-lg font-semibold text-gray-900 mb-4 font-[family:'Inter',sans-serif]">
          {title}
        </h3>
      )}
