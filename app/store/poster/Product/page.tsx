...
export default function PosterProductPage() {
  const media = [
    { kind: "image" as const, src: "/Poster/Posters/pos1.webp", alt: "Poster 1" },
    { kind: "image" as const, src: "/Poster/Posters/pos2.webp", alt: "Poster 2" },
    { kind: "image" as const, src: "/Poster/Posters/pos3.webp", alt: "Poster 3" },
    { kind: "image" as const, src: "/Poster/Posters/pos4.webp", alt: "Poster 4" },
  ];
  ...
  return (
    <main className="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-10 py-10 md:py-16">
      ...
      <section className="grid gap-10 md:grid-cols-2 lg:gap-16 items-start">
        ...
        <div className="w-full">
          <PosterBuy
            title="Sacred Geometry Poster"
            sku="POSTER-001"
            price={{ mrp: 1199, sale: 899 }}
            sizes={[
              { label: "A4", value: "A4" },
              { label: "A3", value: "A3" },
              { label: "A2", value: "A2" },
      ...
      <section className="mt-16">
        <PosterDetail
          ...
          description="Elevate your space with this divine sacred geometry poster — designed to harmonize energy and bring calmness to your environment. Printed on premium paper with a stunning finish, this piece embodies both artistry and spiritual depth."
          benefits="Perfect for meditation rooms, yoga spaces, offices, and homes seeking spiritual energy and positivity."
          badges={["High Quality", "Fade Resistant", "Museum Grade"]}
          className="max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-12 py-10"
        />
      </section>
