...
function generateChartData(formData: KundliFormData): {
  birthChart: number[][]
  navamsa: number[][]
  dashamsa: number[][]
} {
...
function generatePlanetaryPositions(formData: KundliFormData): Array<{
  planet: string
  sign: string
  degree: string
  house: number
...
function generatePredictions(): Array<{
  category: string
  description: string
  ...
  return [
    {
      ...
      description:
        "Excellent prospects in technology and communication fields. Strong potential for growth and advancement in your chosen field.",
      strength: "high",
    },
    {
      category: "Finance & Wealth",
      description:
        "Steady financial growth with multiple income sources. Good opportunities for investments and savings.",
      strength: "high",
    },
    {
      category: "Health & Vitality",
      description:
        "Generally robust health with strong immunity. Maintain regular exercise and a balanced diet.",
      strength: "medium",
    },
    {
      category: "Marriage & Relationships",
      description:
        "Harmonious relationships with spouse and family. Favorable time for partnerships and commitments.",
      strength: "high",
    },
    {
      category: "Education & Learning",
      description:
        "Strong inclination towards higher studies and research. Good time to pursue certifications or skill development.",
      strength: "medium",
    },
  ]
}
