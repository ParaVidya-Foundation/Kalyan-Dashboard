    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D2 • Hora Chart"
          subtitle="Wealth, Finances, and Material Prosperity. A divisional chart specifically analyzing wealth accumulation patterns, financial prosperity, and material possessions in life."
        />
