    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          ...
          subtitle="Marriage, Dharma, and Spiritual Maturity. The most important divisional chart after D1, revealing spouse nature, marriage quality, dharma, spiritual growth, and karmic refinement."
        />
