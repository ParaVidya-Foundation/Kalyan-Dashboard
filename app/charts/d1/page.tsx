    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          ...
          subtitle="The primary birth chart representing your complete personality, life path, and karmic blueprint. This is the foundation of all astrological analysis in Vedic astrology."
        />
