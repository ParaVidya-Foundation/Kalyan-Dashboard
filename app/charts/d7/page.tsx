    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          ...
          subtitle="Children, Creativity, and Progeny. A divisional chart specifically analyzing children, progeny matters, creativity, artistic abilities, and potential for having offspring."
        />
