    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D16 • Kalamsa Chart"
          subtitle="Spiritual Path and Inner Peace. A divisional chart focusing on spirituality, meditation, inner peace, spiritual practices, and connection with higher consciousness."
        />
