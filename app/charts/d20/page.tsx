    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          ...
          subtitle="Spiritual Progress and Devotion. A divisional chart analyzing spiritual progress, religious practices, devotion, and deeper connection with divine energies."
        />
