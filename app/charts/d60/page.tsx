  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D60 • Shashtiamsa Chart"
          subtitle="Ultimate Refinement and Precision. The most detailed divisional chart, providing the finest level of analysis for precise predictions and comprehensive understanding of all life aspects."
        />
