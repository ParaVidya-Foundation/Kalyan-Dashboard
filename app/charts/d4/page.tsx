    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D4 • Chaturthamsa Chart"
          subtitle="Fortune, Property, and Happiness. A divisional chart analyzing fortune, immovable property, assets, happiness, mother, and overall prosperity."
        />
