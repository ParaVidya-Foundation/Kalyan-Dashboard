    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D30 • Trimshamsa Chart"
          subtitle="Evils, Problems, and Challenges. A divisional chart revealing hidden problems, evils, challenges, obstacles, and malefic influences that may cause difficulties in life."
        />
