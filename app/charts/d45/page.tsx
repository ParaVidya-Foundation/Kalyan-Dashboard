    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D45 • Akshavedamsa Chart"
          subtitle="Character, Nature, and Inner Self. A divisional chart analyzing deep character traits, inner nature, behavioral patterns, and fundamental personality characteristics."
        />
