    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          ...
          subtitle="Parents, Ancestors, and Lineage. A divisional chart analyzing parents, ancestors, lineage, past life karma, and inherited traits from family lineage."
        />
