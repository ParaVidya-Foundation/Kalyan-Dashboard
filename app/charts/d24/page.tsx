    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 sm:px-8 lg:px-12 py-12 sm:py-16 lg:py-20">
        <DivisionalChartHeader
          title="D24 • Chaturvimshamsa Chart"
          subtitle="Education, Learning, and Knowledge. A divisional chart analyzing education, learning abilities, knowledge acquisition, academic success, and intellectual pursuits."
        />
