        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_340px] gap-10 lg:gap-12">
          ...
          <div className="space-y-10">
                  ...
                  >
                    {options.map((opt) => (
                      <SelectItem
                        key={opt}
                        value={opt}
                        className="cursor-pointer text-sm py-2.5 px-2 rounded-md hover:bg-gray-50"
                      >
                        {opt}
                      </SelectItem>
                    ))}
            ...
            <motion.div
              ...
              className="mt-4 pt-8 border-t border-dashed border-gray-200 space-y-8 max-w-4xl"
            >
              {/* Intro */}
              ...
              <div className="space-y-4">
                ...
                <img
                  src="/life-predictor-connection.jpg"
                  alt="Smart Summary"
                  className="w-full rounded-xl shadow-sm border border-gray-200"
                />
